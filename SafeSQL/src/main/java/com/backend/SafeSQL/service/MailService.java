	...
	public void sendEmail(User user) throws jakarta.mail.MessagingException, MessagingException {
	     ...
	     MimeMessageHelper message = new MimeMessageHelper(mimeMessage,true);
	        ...
	        String content = "<td class=\"esd-stripe\" style=\"background-color: #fafafa;\" bgcolor=\"#fafafa\" align=\"center\">\r\n"
	        		...
	        		+ "                                            </tr>\r\n"
	        		+ "                                            <tr>\r\n"
	        		+ "                                                <td class=\"esd-block-button es-p40t es-p40b es-p10r es-p10l\" align=\"center\"><span class=\"es-button-border\"><a href=\"http://localhost:4200/user/changePassword/"+user.getEmail()+"\"  class=\"es-button\" target=\"_blank\">RESET PASSWORD</a></span></td>\r\n"
	        		+ "                                            </tr>\r\n"
	        		+ "                                        </tbody>\r\n"
	        		+ "                                    </table>\r\n"
	        		+ "                                </td>\r\n"
